...
back_to_list:;
				...
				while (1) {
					...
					if (track.current == 7) {
						...
						/* sel_index: 0=已出发(DEPARTED), 1=已到达中转站(TRANSIT), 2=已送达(DELIVERED), 3=异常(ABNORMAL) */
